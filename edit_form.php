...
if(empty($_GET['dvd_title_id']) || trim($_GET['dvd_title_id']) == ''){
	...
	<div class="container">
			...
			<form action="edit_confirmation.php" method="POST">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<textarea name="award" id="award-id" class="form-control" value="<?php echo $dvd['award']; ?>"></textarea>
					</div>
				</div> <!-- .form-group -->
